...
@Config
public class RightPixelColorSensor {
    public ColorRangeSensor sensor;

    public static double whiteRedLow = 150, whiteGreenLow = 200, whiteBlueLow = 150;
    ...
    public RightPixelColorSensor(ColorRangeSensor sensor){
        this.sensor = sensor;
